...
| 痛点 | 它怎么解决 |
|---|---|
| 装了 bilibili-cli 但 AI 不会用 | CLI 只是命令手册；本技能教 AI **标准工作流**：识别单P/多P/合集 → 并行抓取 → 质量评估 → 按需补视觉 → 输出 |
...
和 [bilibili-cli](https://github.com/public-clis/bilibili-cli) 的分工：**它是命令手册，本技能是使用手册**。CLI 告诉 AI"有哪些命令"，本技能告诉 AI"拿到一个 B站链接后按什么流程处理、每一步怎么判断"。
